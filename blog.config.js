...
const BLOG = {
  //https://shadowed-pressure-ec2.notion.site/799afe44d985489fb82a2894a6f7178c?pvs=4
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '799afe44d985489fb82a2894a6f7178c',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我还没想要怎么介绍自己',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '不君子', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '1/4新闻人;1/4设计师;1/2程序员', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || '', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 程序员', // 网站关键词 英文逗号隔开
